...
var DaoCrawlerService = /** @class */ (function () {
    ...
    DaoCrawlerService.prototype.getTransactionDetail = function (transactionHash) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.provider.getTransaction(transactionHash)];
                    case 1: 
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        _a.label = 2;
                    case 2:
                        if (!(from < txCount)) return [3 /*break*/, 11];
                    ...
                    return [4 /*yield*/, this.saveToDb(acceptedEvents)];
                    case 9:
                        //saveToDb will be call after crawling each batch
                        //TODO: checkpoint need to be saved
                        _a.sent();
